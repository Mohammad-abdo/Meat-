      ...
      <Accordion expanded={expanded}
       onChange={handleAccordionChange}className='w-full bg-transparent border-b border-[#ec9823] '>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography className="text-[#BC955A] text-[15px] md:text-2xl font-semibold w-full md:mx-8 ">{head}</Typography>
        </AccordionSummary>
        <AccordionDetails className='border-t border-[#ec9823] '>
          <Typography className='text-[12px] md:text-xl text-white md:mx-8 py-2 md:py-10'>{info}</Typography>
        </AccordionDetails>
      </Accordion>
    </div>
  );
